        ...
        <b-card>
            <b-card-text>
                <b-row>
                    ...
                    <b-col md="3">
                        <b-form-group label="Đã học IELTS" label-for="v-to-class">
                            <b-form-select v-model="learnChoose" :options="learnOptions" id="v-to-class"/>
                        </b-form-group>
                    </b-col>
                    <b-col md="3">
                        <!-- <b-form-group label="Đã làm bài" label-for="v-to-couponstate">
                            <b-form-select v-model="testStatus" :options="testOptions" id="v-to-couponstate" />
                        </b-form-group> -->
                    </b-col>
                </b-row>
                <b-row>
            ...
            this.$http
                .get("/contact", {
                    params: {
                        ...
                        learned: this.learnChoose,
                        test_state: this.testStatus,
